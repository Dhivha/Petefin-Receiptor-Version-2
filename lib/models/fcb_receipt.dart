class FCBReceipt {
  ...
  FCBReceipt({
    ...
    this.amount = 1.0, // Always 1 as specified
  ...
  factory FCBReceipt.fromJson(Map<String, dynamic> json) {
    return FCBReceipt(
      id: json['id']?.toString(),
...
class CancelledFCBReceipt {
  ...
  factory CancelledFCBReceipt.fromJson(Map<String, dynamic> json) {
    return CancelledFCBReceipt(
      id: json['Id']?.toString(),
      branch: json['Branch'] ?? '',
